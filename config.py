...
parser.add_argument('--dir_data',
                    type=str,
                    # default='/home/zl/dataset/KITTI',
                    default='/home/zl/dataset/nyudepthv2',
...
parser.add_argument('--model_name',
                    type=str,
                    default='Diffusion_DCbase_',
                    choices=('NLSPN', 'Diffusion_DCbase_', 'Diffusion_DCx4base_','Diffusion_TODEbase_'),
                    help='model name')
...
parser.add_argument('--backbone_module',
                    type=str,
                    default='tode_zl',
                    choices=('mmbev_resnet', 'swin', 'mpvit', 'tode_zl'),
...
parser.add_argument('--pretrain',
                    type=str,
                    default=None,
                    # default='/home/zl/zl_dev/Diffusion/DiffusionDepth/experiments/231214_184933_trial/model_00029.pt',
                    help='ckpt path')
...
if args.pretrain is not None:
     x = args.pretrain.split('/')[-2]
     save_dir = '../experiments/' + x
else:
     save_dir = '../experiments/' + current_time + args.save
